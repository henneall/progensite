<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class=""><a href="<?php echo base_url(); ?>index.php/masterfile/location_list">Location </a></li>
						...
						<div class="col-lg-12">
							<form method='POST' action="<?php echo base_url(); ?>index.php/masterfile/edit_location">
								...
								<div class="col-lg-6">
									...
									<input class="form-control" type="text" name="location" value="<?php echo $loc->location_name; ?>">
									<br>
