<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class=""><a href="<?php echo base_url(); ?>index.php/masterfile/department_list">Department </a></li>
						...
						<div class="col-lg-12">
							<form method='POST' action="<?php echo base_url(); ?>index.php/masterfile/edit_department">
								...
								<div class="col-lg-6">
									...
									<input class="form-control" type="text" name="department" value="<?php echo $dep->department_name; ?>">
									<br>
