<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class=""><a href="<?php echo base_url(); ?>index.php/masterfile/endUse_list">End-User </a></li>
			...
			<div class="panel panel-default shadow">
				...
				<div class="panel-body">
					<div class="canvas-wrapper">
						<div class="col-lg-12">
							<form method='POST' action="<?php echo base_url(); ?>index.php/masterfile/edit_end">
