			...
			<div class="panel panel-default shadow">
				<div class="panel-heading">
					...
					<div class="btn-group pull-right">
						...
						<a class=" clickable panel-toggle panel-button-tab-right shadow"  data-toggle="modal" data-target="#addEngine">
						...
						<div class="accordion " id="accordionExample">
							...
							<div class="card m-b-5 " id="engines">
								<div class="btn-group btn-block bor-radius100"> 
							        ...
							        <a href="<?php  echo base_url();?>index.php/assembly/engview_list/<?php echo $en->engine_id; ?>" target="_blank" class="btn btn-success" type="button" style="width: 5%">
										<div class="card-header" id="headingOne">
											<h4 class="mb-0">
							        ...
							        <a href="" class="btn btn-success" type="button"data-toggle="modal" id="updateEngine_button" data-id="<?php echo $en->engine_id; ?>" data-trigger="<?php echo $en->engine_name; ?>" data-target="#updateEngine" style="width: 5%">
										<div class="card-header" id="headingOne">
											<h4 class="mb-0">
							        ...
							        <a href="" class="btn btn-success" type="button" data-toggle="modal" data-trigger="<?php echo $en->engine_id; ?>" data-target="#addAssembly" id='addAssembly_button' style="width: 5%">
										<div class="card-header" id="headingOne">
											<h4 class="mb-0">
							      	...
							      	<div class="card-body p-l-60  p-t-5 ">
							        	...
							        	<div class="card m-b-5" id="engines_sub">
											<div class="btn-group btn-block ">
											    ...
											    <button class="btn btn-sm btn-default border-acc" type="button" data-toggle="collapse" data-target="#collapseAssembly<?php echo $ass; ?>" aria-expanded="true" aria-controls="collapseAssembly<?php echo $ass; ?>" style="width:80%">
													<div class="card-header" id="headingOne">
										        ...
										        <a href="<?php  echo base_url();?>index.php/assembly/complete_list/<?php echo $en->engine_id; ?>/<?php echo $as->assembly_id; ?>" target="_blank" class="btn btn-sm btn-info" type="button" style="width:5%">
										        ...
										        <a class="btn btn-sm btn-info" type="button" data-toggle="modal" id="updateAssembly_button" data-target="#updateAssembly" data-id="<?php echo $as->assembly_id; ?>" data-trigger="<?php echo $as->assembly_name; ?>"  style="width:5%">
													<div class="card-header">
														<h5 class="mb-0">
															<span class="fa fa-pencil text-white"></span>
												      	</h5>
										        ...
										        <a class="btn btn-sm btn-info" type="button" data-toggle="modal" data-target="#addItem"  data-trigger="<?php echo $as->assembly_id; ?>" id='addItem_button' style="width:5%">
													<div class="card-header" >
														<h5 class="mb-0">
															<span class="fa fa-plus text-white"></span>
												      	</h5>
											      			...
											      			<tbody>
											      			   ...
											      			   foreach($items AS $i){ 
												      			...
												      			<tr>
												      				...
												      				<td align="center">
												      					<a href="" class="btn btn-xs btn-info" onclick="updateItemAssem()"><span class="fa fa-pencil"></span></a>
												      					<a href="" class="btn btn-xs btn-danger"><span class="fa fa-times"></span></a>
												      				</td>
												      			</tr>
