...
<script type="text/javascript">
	...
	function enableEngine(){
		...
		/* document.getElementById("engine").removeAttr('disabled');
		document.getElementById("assembly").removeAttr('disabled');*/
		if(location=='4'){
			$("#engine_div").show();
			$("#assembly_div").show();
		} else {
		...
		<ul class="nav menu">
			...
			<li class="parent ">
				...
				<ul class="children collapse" id="sub-assembly">
					...
					<li>
						<a class=""  data-toggle="modal" data-target="#tranferTo" style="cursor: pointer;">
