...
backup_tables('localhost','root','1t@dm1N','db_progen');
$now=date("Y-m-d");
...
rcopy($copysql , "C:\Onedrive_link\/BagoProgen\/db_backup\/".$data);
fclose($handle);
}
...
rcopy($fname , "C:\Onedrive_link\/BagoProgen\/uploads\/".$zipname);
//rrmdir($fname);
/*
